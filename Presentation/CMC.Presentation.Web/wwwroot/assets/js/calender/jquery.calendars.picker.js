...
function CalendarsPicker() {
	this._defaults = {
		calendar: $.calendars.umElQuraInstance(), // The calendar to use
		pickerClass: '', // CSS class to add to this umElQuraInstance of the datepicker
	...
	this.regional[''] = { // Default regional settings
		...
		clearText: 'تفريغ', // Text for the clear command
		...
		defaultStatus: 'اختر التاريخ', // Status text shown by default
...
$.extend(CalendarsPicker.prototype, {
	...
	/* Name of the data property for umElQuraInstance settings. */
	...
	/* Override the default settings for all calendar picker umElQuraInstances.
	...
	/* Attach the calendar picker functionality to an input field.
	   ...
	   @param  options  (object) the custom options for this umElQuraInstance */
	...
	/* Retrieve or reconfigure the settings for a control.
	   @param  target   (element) the control to affect
	   @param  options  (object) the new options for this umElQuraInstance or
	...
	/* Attach events and trigger, if necessary.
	   ...
	   @param  inst    (object) the current umElQuraInstance settings */
	...
	/* Hide a popup datepicker.
	   @param  target     (element) the control to use or
	                      (object) the current umElQuraInstance settings
...
/* Attach the calendar picker functionality to a jQuery selection.
   @param  options  (object) the new settings to use for these umElQuraInstances (optional) or
...
var plugin = $.calendars.picker = new CalendarsPicker(); // Singleton umElQuraInstance

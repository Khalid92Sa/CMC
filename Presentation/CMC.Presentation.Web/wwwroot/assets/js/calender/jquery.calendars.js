...
$.extend(Calendars.prototype, {
	...
	umElQuraInstance: function(name, language) {
	...
	newDate: function(year, month, day, calendar, language) {
		calendar = (year != null && year.year ? year.calendar() : (typeof calendar == 'string' ?
			this.umElQuraInstance(calendar, language) : calendar)) || this.umElQuraInstance();
...
$.extend(BaseCalendar.prototype, {
	...
	toJSDate: function(year, month, day) {
		var date = this._validate(year, month, day,
			$.calendars.local.invalidDate || $.calendars.regional[''].invalidDate);
		return $.calendars.umElQuraInstance().fromJD(this.toJD(date)).toJSDate();
	},
	...
	fromJSDate: function(jsd) {
		return this.fromJD($.calendars.umElQuraInstance().fromJSDate(jsd).toJD());
	},
